...
#define NVME_UPDATE_SQ_TAIL(Q)  Q.Submission_queue_tail++;\
	...
	class IO_Flow_Base : public MQSimEngine::Sim_Object, public MQSimEngine::Sim_Reporter, public MQSimEngine::QTComp
	{
	public:
		IO_Flow_Base(const sim_object_id_type &name, uint16_t flow_id, LHA_type start_lsa_on_device, LHA_type end_lsa_address_on_device, uint16_t io_queue_id,
					 ...
					 bool enabled_logging, sim_time_type logging_period, std::string logging_file_path, uint64_t QTSendCount);
		~IO_Flow_Base();
