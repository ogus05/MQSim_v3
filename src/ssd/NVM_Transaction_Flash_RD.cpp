...
namespace SSD_Components
{
	NVM_Transaction_Flash_RD::NVM_Transaction_Flash_RD(Transaction_Source_Type source, stream_id_type stream_id,
		...
		Content(content), RelatedWrite(related_write), read_sectors_bitmap(read_sectors_bitmap), DataTimeStamp(data_timestamp), originTr(NULL)
	{
	}
	...
	NVM_Transaction_Flash_RD::NVM_Transaction_Flash_RD(Transaction_Source_Type source, stream_id_type stream_id,
		...
		Content(content), RelatedWrite(NULL), read_sectors_bitmap(read_sectors_bitmap), DataTimeStamp(data_timestamp), originTr(NULL)
	{
	}
